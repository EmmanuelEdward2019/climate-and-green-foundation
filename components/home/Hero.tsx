      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <p
              className="font-garamond text-white/85 max-w-2xl mx-auto lg:mx-0 mb-10 leading-relaxed animate-fade-up opacity-0 [animation-delay:200ms]"
          ...
          {/* Stats panel */}
          <div
            className="lg:col-span-5 animate-fade-up opacity-0 [animation-delay:400ms]"
          >
