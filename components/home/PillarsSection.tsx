...
const pillars = [
  ...
  },
  {
    ...
    body: `Environmental work that ignores people fails. We invest in the women, men, farmers, and young people who live on the land through climate education, awareness sensitization, and dialogue that take local livelihoods seriously - while protecting the environment.`,
  ...
  },
  {
    ...
    body: `We not only plant trees, we dissuade farmers from bush burning, and cutting of trees for firewood and enlighten communities on waste disposal and environmental best practices.`,
